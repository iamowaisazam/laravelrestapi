...
<div class="container-fluid">
            ...
            <div class="row">
              <div class="col-12">
                  <div class="page-title-box d-flex align-items-center justify-content-between">
                      <h4 class="mb-0 font-size-18">Vendor Payables</h4>
        ...
        <!-- end page title -->
          ...
          <div class="row">
            <div class="col-12">
             <form method="post" action="{{route('admin.accounts_vendorspayables.update',$module->id)}}"  >
                @csrf
                            ...
                            <div class="row">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <select name="vendor_id" class="vendor_id form-control" >
                                            @foreach(Con::vendors() as $vendor)    
                                              <option data-id="{{Con::vendor_balance($vendor->id)}}"  @if($module->vendor_id == $vendor->id) {{'selected'}} @endif value="{{$vendor->id}}" >{{$vendor->name}}</option>
                                            @endforeach
                                        </select>
                                     </div>
                                </div>
                                ...
                                <div class="col-md-3 cheque_date">
                                     <div class="form-group">
                                        ...
                                        <input  value="{{$module->cheque_date->format('Y-m-d')}}"  name="cheque_date" type="date" class="form-control">
                                     </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                     <div class="form-group">
                                        <label>Amount</label>
                                        <input min="0" step=".01" value="{{$module->amount}}" required name="amount" type="number" class="amount form-control">
                                     </div>
                                </div>
