...
<div class="container-fluid">
        ...
        <!-- end page title -->
          ...
          <div class="row">
            <div class="col-12">
             <form method="post" action="{{route('admin.accounts_vendorspayables.store')}}"  >
                @csrf
                    ...
                    <div class="container-fluid">
                            <div class="row">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <select name="vendor_id" class="form-control vendor_id" >
                                            @foreach(Con::vendors() as $vendor)    
                                              <option data-id="{{Con::vendor_balance($vendor->id)}}" value="{{$vendor->id}}" >{{$vendor->name}}</option>
                                            @endforeach
                                        </select>
                                     </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                     <div class="form-group">
                                        <label>Amount</label>
                                        <input step=".01" min="0" value="10" required name="amount" type="number" class="amount form-control">
                                     </div>
                                </div>
