                ...
                <div class="container-fluid">
                    ...
                    <div class="row" >
                      ...
                      <div class="col-md-4" >
                              ...
                              <input value="{{$module->date->format('Y-m-d')}}" />
                      </div>                          
                      <div class="col-md-4" >
                              <label>Customer: </label>
                              <input value="{{$module->customer->name }}" />
                      </div>
                      <div class="col-md-3" >
                        <label >Color: </label>
                        <input value="{{$module->color}}" />
                     </div>
                   
                      <div class="col-md-5" >
                           <label>Customer Weight kg / Roll: </label>
                           <input value="{{$module->qty_type}} {{$module->qty}}" />
                      </div>
                    
                      <div class="col-md-4" >
                              <label>Fabric Quality: </label>
                              <input value="{{$module->fabric_quality}}" />

                      </div>
                      <div class="col-md-4" >
                        <label>Party challan: </label>
                        <input value="{{$module->party_challan}}" />
                     </div>
                      <div class="col-md-4" >
                              <label>Party Job Number: </label>
                              <input value="{{$module->party_job_number}}" />

                      </div>
                      <div class="col-md-4" >
                          <label>Production Date: </label>
                          <input value="{{$module->production_date->format('Y-m-d')}}" />
                      </div>
                      
                      <div class="col-md-4" >
                          <label>Issue Date: </label>
                          <input value="{{$module->issue_date ? $module->issue_date->format('Y-m-d') : '' }}" />
                      </div>
                      
                      <?php $entry = explode(',',$module->shift_entry); ?>
                      <div class="col-md-5" >
                          <label>Shift Entry: </label>
                          <input value="@foreach(Con::shifts() as  $shifts)@if(in_array($shifts,$entry)){{$shifts}},@endif @endforeach" />
                      </div>
                      
                      <div class="col-md-3" >
                          <label>Ref Lot: </label>
                          <input value="{{$module->ref->serial_no}}" />
                      </div>
                      ...
                      <div class="col-md-6" >
                          ...
                          <input value="@foreach(Con::machines() as $machine)@if(in_array($machine->title,$machiness)){{$machine->title}},@endif @endforeach" />
                      </div>
                      <div class="col-md-6" >
                              <?php  $process = explode(",",$module->lot_process); ?>
                             <label>Process: </label>
                             <input value="@foreach(Con::lot_process() as $item)@if(in_array($item->id, $process)){{$item->title}}@endif @endforeach" />
                     </div>
                  </div>
                  </div>
                        ...
                        <tbody>
                          ...
                          <?php $lotQualityTotal += $item->weight;  ?>
                             <tr>
                                ...
                                <td class="text-center">{{ number_format($item->rolls,2)}}</td>
               ...
               <div class="invoice-header">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                  <td style="border: 0px;" colspan="5"></td>
                                  <td class="text-center">Fresh Lot Total</td>
                                  <td class="text-center" >{{$module->ref->gtotal}}</td>
                                </tr>
                                <tr>
                                  <td style="border: 0px;" colspan="5"></td>
                                  <td class="text-center">Final Total</td>
                                  <td class="text-center" >{{$module->ref->gtotal + $module->gtotal}}</td>
                                </tr>
                            </tbody>
                          </table>
                      </div>
