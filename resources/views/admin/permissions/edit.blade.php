    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      <div class="d-flex align-items-center flex-wrap mr-2">
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
          ...
          <li class="breadcrumb-item">
          <a href="{{route('admin.permissions.index')}}" class="text-muted">Permission</a>
          </li>
          <li class="breadcrumb-item active">
            <a href="{{route('admin.permissions.edit',$permission->id)}}" class="">Edit</a>
          </li>
        </ul>
      </div>
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-xl-7 my-2">
              ...
              <!--begin::Row-->
            @endif
            <form method="post" action="{{route('admin.permissions.update',$permission->id)}}"  id="user_create_form" class="form-horizontal">
                @csrf
                @method('PUT')
                      <div class="form-body">
                        <div class="form-group row">
                          ...
                          <div class="col-9">
                            <input required name="name" value="{{$permission->name}}"  class="form-control form-control-lg " type="text" >
                          </div>
                        </div>
                        <div class="form-group row">
                          <label class="col-form-label col-3 text-lg-right text-left">Details</label>
                          <div class="col-9">
                              <textarea required class="form-control" name="detail"  cols="30" rows="10">{{$permission->detail}}</textarea>
                          </div>
                        </div>
