...
<div class="container-fluid">
       ...
       <!-- start page title -->
          <div class="row">
            <div class="col-12">
                <div class="beard page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="col-12">
              <div class=" card">
                <div class="card-body">
                  ...
                  <form class="pt-3" enctype="multipart/form-data" method="post" action="{{route('admin.types.update',$module->id)}}"  >
                      @csrf
                        ...
                        <div class="form-group">
                            ...
                            @endif
                            <br>
                            <img style="width:100px" src="{{asset($module->thumbnail)}}" class="pt-3" />
                        </div>
