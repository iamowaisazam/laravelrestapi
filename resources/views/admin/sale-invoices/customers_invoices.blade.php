       ...
       <div class="card">
          <div class="card-body">
            <div class="pt-1 pb-4 container-fluid">
                <div class=" row">
                    <div class="col-6"><h4 class="card-title">"{{$customer->name}}" Invoices </h4></div>
                    <div class="col-6 text-right "><a class="btn btn-primary" href="{{route('admin.sale-invoices.customers')}}" >Back</a></div>
                </div>
            </div>
      ...
      <script>
        $(document).ready(function(){
            ...
            var table = $('.data-table').DataTable({
              ...
              serverSide: true,
              pageLength: 50,
              ajax: "{{route('admin.sale-invoices.customers_invoices',$customer->id) }}",
              columns: [
                         { 
                            data: 'serial_no', 
                            name: 'serial_no'
