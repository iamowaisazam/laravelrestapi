...
<div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        <form method="post" action="{{route('admin.purchase_orders.dori_for_tags_update',$orderid)}}"  >
            @csrf
            ...
            <div class="container-fluid">
                    <div class="table-responsive">
                        <table>
                            <thead>
                                <tr>
                                    <th style="text-align: center" >Dori For Tags</th>
                            ...
                            <tbody class="items-list">  
                                ...
                                <tr>
                                    ...
                                    <td style="width: 100px;">
                                        <input name="items[{{$key}}][remarks]" value="{{$item->remarks}}" class="qty form-control"/>
                                    </td>
