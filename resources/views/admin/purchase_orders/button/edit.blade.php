...
<div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        <form method="post" action="{{route('admin.purchase_orders.button_update',$orderid)}}"  >
            @csrf
                            ...
                            <tbody class="items-list">  
                                ...
                                <tr>
                                    <td>{{$item->attribute->title}}
                                        ...
                                        <input value="{{$item->id}}" name="items[{{$key}}][item_id]" type="hidden"/>
                                    </td>
                                    <td style="width: 100px;">
                                        <input name="items[{{$key}}][remarks]" value="{{$item->remarks}}" class="form-control"/>
                                    </td>
                                    <td style="width: 82px;">
                                        <select name="items[{{$key}}][holes]" class="form-control">
                                            <option @if($item->holes == 2) {{'selected'}} @endif>2</option>
                                            <option @if($item->holes == 4) {{'selected'}} @endif>4</option>
                                        </select>
                                    </td>
                                    ...
                                    <td style="width: 82px;" >
                                        <input value="{{$item->price}}" name="items[{{$key}}][rate]" class="rate form-control"/>
                                    </td>
        ...
        $('.addproduct').click(() => {
            ...
            if(productId != null){
                $('.items-list').append(`<tr>
                                    ...
                                    <td style="width: 82px;">
                                        <input name="items[${key}][rate]" class="rate form-control"/>
                                    </td>
                                    <td class="text-center total">0</td>
                                    <td class="text-center"><button type="button" class="delete_item btn-little"><i class="text-danger fa-2x fas fa-window-close"></i></button></td>
                                </tr>`);
