...
@section('title','Purchase Reciept')
@section('css')
    ...
    <div class="card">
          <div class="card-body">
            <div class=" pt-1 pb-3 container-fluid">
              <div class="row">
                <div class="col-6"><h4 class="card-title">All Orders "{{$type->title}}"</h4></div>
                <div class="col-6 text-right ">
                  <a class="btn btn-primary" href="{{route('admin.purchase_orders.edit',['type' => $type->slug,'id' => 0])}}">Add New</a>
                </div>
              </div>
            </div>
...
<script>
  $(document).ready(function(){
     let route = "{{route('admin.purchase_orders.type',$type->id)}}";
