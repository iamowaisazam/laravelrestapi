...
<div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        <form method="post" action="{{route('admin.purchase_orders.lining_update',$orderid)}}"  >
            @csrf
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center">Yards/mtr</th>
                            ...
                            <tbody class="items-list">  
                                ...
                                <tr>
                                    ...
                                    <td style="width: 82px;">
                                        <input name="items[{{$key}}][width]" value="{{$item->width}}" class="form-control"/>
                                    </td>
                                    <td style="width: 120px;">
                                        <input name="items[{{$key}}][yards]" value="{{$item->yards}}" class="form-control"/>
                                    </td>
                                    <td style="width: 82px;">
        ...
        $('.addproduct').click(() => {
            ...
            if(productId != null){
                $('.items-list').append(` <tr>
                                    ...
                                    <td style="width: 120px;">
                                        <input name="items[${key}][yards]" class="form-control"/>
                                    </td>
                                    <td style="width: 82px;">
