                            ...
                            <div class="invoice-header">
                                <table >
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($order->items as $key => $item)
                                              ...
                                              ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{$item->yards}}</td>
                                                    <td class="text-center">{{number_format($item->yards * 0.9144,2)}}</td>
                                                    <td class="text-center">{{$item->width}}</td>
                                                    <td class="text-center">{{$item->rolls}}</td>
                                        ...
                                        @endforeach
                                        <tr>
                                            <td style="border: 0px;vertical-align: bottom;" rowspan="3" colspan="9">
