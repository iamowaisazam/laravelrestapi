...
<div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        <form method="post" action="{{route('admin.purchase_orders.furing_update',$orderid)}}"  >
            @csrf
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center">Yards Number</th>
                                    <th style="text-align: center">Yards Meter</th>
                            ...
                            <tbody class="items-list">  
                                ...
                                <tr>
                                    ...
                                    <td style="width: 150px;">
                                        <input value="{{$item->yards}}" name="items[{{$key}}][yards]" class="yards form-control"/>
                                    </td>
                                    <td style="width: 90px;" class="yards_in_meter" >0</td>
                                    <td style="width: 70px;">
    ...
    $(document).ready(function () {
       ...
       let fd = $(".product_id").select2({
        ...
        $('.addproduct').click(() => {
            ...
            if(productId != null){
                $('.items-list').append(`<tr>
                                    <td>${productTitle}
                                    <input value="${productId}" name="items[${key}][attribute_id]" type="hidden" /></td>
                                    <td style="width: 100px;">
                                    ...
                                    <td style="width: 150px;">
                                        <input  name="items[${key}][yards]" class="yards form-control"/>
                                    </td>
                                    <td style="width: 90px;" class="yards_in_meter" >0</td>
                                    <td style="width: 70px;">
                                        <input name="items[${key}][width]" class="form-control"/>
                                    </td>
                                    <td style="width: 70px;">
                                        <input name="items[${key}][rolls]" class="form-control"/>
                                    </td>
                                    <td style="width: 82px;">
        ...
        function calculate(){
                ...
                let yards = parseFloat(main.find('.yards').val());
                yards = isNaN(yards) ? 0 : yards;
                
                let total = qty * rate;
                let step = yards * 0.9144;
                
                main.find('.yards_in_meter').text(step.toFixed(2));

                main.find('.total').text(total);
            });
        }
