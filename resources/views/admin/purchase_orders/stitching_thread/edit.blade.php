...
<div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        <form method="post" action="{{route('admin.purchase_orders.stitching_thread_update',$orderid)}}"  >
            @csrf
            ...
            <div class="container-fluid">
                    <div class="table-responsive">
                        <table>
                            <thead>
                                <tr>
                                    <th style="text-align: center" >Stitching Thread</th>
                            ...
                            <tbody class="items-list">  
                                ...
                                <tr>
                                    ...
                                    <td style="width: 80px;">
                                        <input value="{{$item->yards}}" name="items[{{$key}}][yards]" class="form-control"/>
                                    </td>
                                    <td style="width: 82px;">
