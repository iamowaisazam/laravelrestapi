                            ...
                            <div class="invoice-header">
                                <table >
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($order->items as $key => $item)
                                              ...
                                              ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{$item->fabric}}</td>
                                                    <td class="text-center">{{$item->description}}</td>
                                                    <td class="text-center">{{$item->furing}}</td>
                                                    <td class="text-center">{{$item->button}}</td>
                                        ...
                                        @endforeach
                                        <tr>
                                            <td style="border: 0px;vertical-align: bottom;" rowspan="3" colspan="12">
