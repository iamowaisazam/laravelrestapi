                                ...
                                <table >
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Rate In (Yards)</th>
                                            <th>Rate In (Meter)</th>
                                            <th>Total Price in (Yards)</th>
                                            <th>Total Price in (Meter)</th>
                                        </tr>        
                                    </thead>
                                    <tbody>
                                        <?php 
                                        ...
                                        @foreach($order->items as $key => $item)
                                              ...
                                              ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{$item->qty * 0.9144}}</td>
                                                    <td class="text-center">{{$item->price}}</td>
                                                    <td class="text-center">{{$item->price * 0.9144}}</td>
                                                    <td class="text-center">{{$total}}</td>
                                                    <td class="text-center" >{{$total * 0.9144}}</td>
                                                </tr>
                                        @endforeach
                                        <tr>
                                            ...
                                            <td style="font-weight: bold" class="text-center">Yards Total:</td>
                                            <td class="text-center">{{number_format($subtotal,2)}}</td>
                                            <td style="font-weight: bold" class="text-center">Meter Total:</td>
                                            <td class="text-center">{{number_format($subtotal * 0.9144,2)}}</td>
                                        </tr>
                                        <tr class="d-none" >
