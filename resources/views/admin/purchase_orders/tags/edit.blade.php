...
<div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        <form method="post" action="{{route('admin.purchase_orders.tags_update',$orderid)}}"  >
            @csrf
                        ...
                        <table>
                            ...
                            <tbody class="items-list">  
                                ...
                                <tr>
                                    ...
                                    <td style="width: 140px;">
                                        <select name="items[{{$key}}][style]"  class="form-control" >
                                            @foreach ($styles as $style)
                                            <option @if($style->title == $item->style){{'selected'}} @endif >{{$style->title}}</option>    
                                            @endforeach
                                        </select>
                                    </td>
                                    <td style="width: 82px;">
