        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              ...
              <form  method="post" action="{{route('admin.stock-adjustments.update',$module->id)}}"  >
                  @csrf       
                               <div class="row" >
                              <div class="col-md-6" >
                              <div class="form-group">
                                  ...
                                  <select required class="js-example-basic-single form-control"  name="product_id">
                                     @foreach(Con::products() as $product)
                                      <option @if($product->id == $module->product_id) {{'selected'}} @endif value="{{$product->id}}" >{{$product->title}}</option>
                                     @endforeach
                                  </select>
                              ...
                              <div class="form-group">
                                  ...
                                  <input required value="{{date('Y-m-d\TH:i', strtotime($module->date))}}" name="date" type="datetime-local"  class="form-control" />
                                  @if($errors->has('date'))
                             ...
                             <div class="form-group">
                                ...
                                <input required step=".01" value="{{$module->qty}}" name="qty" type="number"  class="form-control" />
                                @if($errors->has('qty'))
                             ...
                             <div class="form-group">
                                ...
                                <input required step=".01" value="{{$module->rate}}" name="rate" type="number"  class="form-control" />
                                @if($errors->has('rate'))
                              ...
                              <div class="form-group">
                                  ...
                                  <select required class="form-control" name="type">
                                      <option @if($module->type == 'Increament') {{'selected'}} @endif>Increament</option>
                                      <option @if($module->type == 'Decrement' ) {{'selected'}} @endif>Decrement</option>
                                  </select>
                                  @if($errors->has('type'))
