...
<div class="container-fluid">
    ...
    <!-- end page title -->
      ...
      <div class="row">
        <div class="col-12">
             <form class="py-3"  method="post" action="{{route('admin.purchases.update',$module->id)}}"  >
            ...
            <div class="container-fluid">
                @csrf
                    <div class="pt-2 pb-3" > 
                        <div class="row" > 
                              <div class="col-md-6" >
                                <select class="product-type form-control" >
                              ...
                              <div class="col-md-5" >
                                <select class="add-product form-control" >
                                  ...
                                  @foreach(Con::products() as $product)
                                    <option data-name="{{$product->title}}" value="{{$product->id}}">{{$product->title}}</option>    
                                  @endforeach
                                </select>
                              </div>
                              <div class="col-md-1" >
                    ...
                    <!--Item Header-->
                     ...
                     <div class="line-items" >
                       ...
                       <div class="row py-1 " > 
                              ...
                              <div class="col-md-6" >
                                <input readonly name="items[{{$key}}][name]" class="form-control" value="{{$item->product->title}}" />
