...
@section('title','Expenses Accounts')
@section('css')
            ...
            <div class="pt-1 pb-4 container-fluid">
                <div class="row">
                    ...
                    <div class="col-6 text-right ">
                      <a class="btn btn-primary" href="{{route('admin.expenses_accounts.create')}}">Add New Account</a>
                    </div>
                </div>
            </div>
   ...
   <script>
    $(document).ready(function(){
        ...
        var table = $('.data-table').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{route('admin.expenses_accounts.index')}}",
          columns: [
                      {
                        data: 'id', 
                        name: 'id'
