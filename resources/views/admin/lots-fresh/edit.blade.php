...
<div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
            <form  method="post" action="{{route('admin.lots-fresh.update',$module->id)}}"  >
                @csrf
                            ...
                            <div class="row" >
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="input-group">
                                          <div class="input-group-prepend">
                                            <span class="input-group-text" >LO-{{$module->date->format('ym')}}</span>
                                          </div>
                                ...
                                <div class="col-md-3" >
                                     <div class="form-group">
                                        ...
                                        <input required name="date" type="date"  class="form-control" value="{{$module->date->format('Y-m-d')}}" />
                                     </div>
                                </div>
                                ...
                                <div class="col-md-3" >
                                    ...
                                    <div class="input-group mb-3">
                                      ...
                                      <input value="{{$module->qty}}" step=".01" name="qty" type="number" class="form-control" placeholder="Quantity" />
                                    </div>
                                </div>
                            ...
                            <div class="py-3 container-fluid" >
                                <div class="row" >
                                    ...
                                    <div class="col-md-2" >
                                      ...
                                      <input required  type="number" name="items[{{$key}}][weight]" step=".01" class="form-control" value="{{$item->weight}}" >
                                    </div>
                                </div>
                            </div>
                        </div>
