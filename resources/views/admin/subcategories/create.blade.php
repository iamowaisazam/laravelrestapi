...
<div class="container-fluid">
  ...
  <div class="row">
       <div class="col-12">
        <form enctype="multipart/form-data" method="post" action="{{route('admin.subcategories.store')}}"  >
          @csrf
          <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-6">
                          <div class="form-group">
                              <label>Title</label>
                              <input  name="title" class="title form-control" value="{{old('title')}}" />
                              @if($errors->has('title'))
                      ...
                      <div class="d-none col-md-6">
                        <div class="form-group">
                          <label>slug</label>
                          <input  name="slug" class="slug form-control" value="{{old('slug')}}" />
                          @if($errors->has('slug'))
                      ...
                      <div class="d-none col-md-6">
                        <div class="form-group">
                          ...
                          <input name="sequence" type="number" class="form-control" value="{{old('sequence')}}" />
                      ...
                      <div class="d-none col-md-6">
                        <div class="form-group">
                          ...
                          <input name="initials" class="form-control" value="{{old('initials')}}" />
