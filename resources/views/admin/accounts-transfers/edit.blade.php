                                     ...
                                     <div class="form-group">
                                        ...
                                        <select class="form-control trasnfer_from" name="sender_id" >
                                            @foreach($accounts as $account)
                                                <option @if($account->id == $module->sender_id) {{'selected'}} @endif value="{{$account->id}}">{{$account->account_name}}</option>
                                            @endforeach
                                        </select>
                                     </div>
                                </div>
                                ...
                                <div class="col-3">
                                     <div class="form-group">
                                        ...
                                        <select class="form-control trasnfer_to" name="receiver_id" >
                                            @foreach($accounts as $account)
                                               <option @if($account->id == $module->receiver_id) {{'selected'}} @endif value="{{$account->id}}">{{$account->account_name}}</option>
                                            @endforeach
                                        </select>
                                     </div>
                                </div>
                                 ...
                                 <div class="form-group col-md-3">
                                        ...
                                        <input required type="date" value="{{$module->date->format('Y-m-d')}}" name="date" class="form-control date">
                                </div>
                                
                                <div class="bal form-group col-md-3">
                                    <label>Amount</label>
                                    <input required  min="1" type="number" name="amount" class="form-control amount" value="{{$module->amount}}" >
