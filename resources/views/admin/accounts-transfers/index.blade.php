      ...
      <div class="card">
          <div class="card-body">
            <div class="pt-1 pb-4 container-fluid">
                <div class="row">
                    <div class="col-6"><h4 class="card-title">All Transfers</h4></div>
                    <div class="col-6 text-right ">
                      <a class="btn btn-primary" href="{{route('admin.accounts_transfers.create')}}">Add New Transfers</a>
                    </div>
                </div>
            </div>
   ...
   <script>
    $(document).ready(function(){
        ...
        var table = $('.data-table').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{route('admin.accounts_transfers.index')}}",
          columns: [
                      {
                        data: 'id', 
                        name: 'id'
