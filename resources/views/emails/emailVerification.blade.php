                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                        <tr>
                                            <td class="p30-15" style="padding: 70px 30px 70px 30px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="h2 center pb10" style="color:#000000; font-family:'Ubuntu', Arial,sans-serif; font-size:50px; line-height:60px; text-align:center; padding-bottom:10px;">{{ 'Email Verification Code' }}</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <td class="h5 center blue pb30" style="font-family:'Ubuntu', 
                                                        ...
                                                        color:#2e57ae; 
                                                        padding-bottom:30px;">  
                                                        {{ isset($verification_code) ? $verification_code : '123123' }}<br><br>
                                                        ...
                                                        border-radius: 5%;
                                                        text-decoration: none;"  href="{{isset($verify_button) ? $verify_button :  'asda'}}" target="_blank" >Click Here</a> </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
